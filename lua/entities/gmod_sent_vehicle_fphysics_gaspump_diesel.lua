...
if CLIENT then 
	...
	function ENT:Draw()
		...
		cam.Start3D2D( self:LocalToWorld( Vector(20,0,1) ), self:LocalToWorldAngles( Angle(0,90,90) ), 0.1 )
			...
			draw.SimpleText( "Дизель", "simfphys_gaspump", 0, -50, Color(255,60,0,150), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
...
function ENT:Initialize()
	...
	self.PumpEnt:SetPos( self:LocalToWorld( Vector(12.2,-24.6,15.7) ) )
	self.PumpEnt:SetAngles( self:LocalToWorldAngles( Angle(-0.3,180,-0.1) ) )
