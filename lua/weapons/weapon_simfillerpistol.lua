...
if CLIENT then
	...
	function SWEP:DrawHUD()
		...
		local sizey = screenh
		local xpos = sizex * 0.006
		local ypos = sizey * 0.66
		...
		if simfphys.IsCar( ent ) then
			...
			draw.RoundedBox(0, 3, ScrH() - 320, 200, 35, Color(0, 0, 0, 200))
			...
			surface.SetDrawColor( 0,0,0,120 )
				surface.DrawOutlinedRect(  xpos, ypos, ((sizex * 0.118) / MaxFuel) * Fuel, sizey * 0.02 )
		else 
